<template>
  <NuxtLink :to="`/servicii/${category.slug}`" class="block group">
    <div class="bg-white rounded-xl border border-gray-100 p-6 shadow-sm hover:shadow-md transition-all duration-200 text-center h-full">
